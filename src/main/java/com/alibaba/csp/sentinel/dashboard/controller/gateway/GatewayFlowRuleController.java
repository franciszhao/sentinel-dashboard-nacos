...
public class GatewayFlowRuleController extends BaseSyncDataController<GatewayFlowRuleEntity> {
...
//            rules = repository.saveAll(rules);
            List<GatewayFlowRuleEntity> rules = this.list(ruleProvider, app);
...
//        GatewayFlowRuleEntity entity = repository.findById(id);
        GatewayFlowRuleEntity entity = this.findById(ruleProvider, reqVo.getApp(), id);
...
//            publishRules(entity.getApp());
    ...
    public Result<Long> deleteFlowRule(Long id, @RequestParam("app") String app) {
...
//    }
    ...
    @Override
    protected void format(GatewayFlowRuleEntity entity, String app) {

    }

    @Override
    protected void merge(GatewayFlowRuleEntity entity, GatewayFlowRuleEntity oldEntity) {
