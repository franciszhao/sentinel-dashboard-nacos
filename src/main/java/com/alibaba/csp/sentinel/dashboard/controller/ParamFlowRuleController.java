...
public class ParamFlowRuleController extends BaseSyncDataController<ParamFlowRuleEntity> {
...
//            rules = repository.saveAll(rules);
            List<ParamFlowRuleEntity> rules = this.list(ruleProvider, app);
...
//        ParamFlowRuleEntity oldEntity = repository.findById(id);
        ParamFlowRuleEntity oldEntity = this.findById(ruleProvider, entity.getApp(), id);
        if (oldEntity == null) {
...
//            publishRules(entity.getApp());
    ...
    public Result<Long> apiDeleteRule(@PathVariable("id") Long id, @RequestParam("app") String app) {
        ...
        ParamFlowRuleEntity oldEntity = this.findById(ruleProvider, app, id);
        if (oldEntity == null) {
...
//    }
    ...
    @Override
    protected void format(ParamFlowRuleEntity entity, String app) {

    }

    @Override
    protected void merge(ParamFlowRuleEntity entity, ParamFlowRuleEntity oldEntity) {
